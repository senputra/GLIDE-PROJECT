...
if( ! brand_is_hidden( 'header' ) ) { ?>
	<div id="header-portfolio-wrapper" <?php brand_header_wrapper_class() ?>>
		<div class="header-portfolio-bg" style="background-image:url(<?php the_post_thumbnail_url( 'full' ); ?>);"></div>
    <?php do_action('brand_before_inside_header');

		if( ! brand_is_hidden( 'headline' ) ) { ?>
